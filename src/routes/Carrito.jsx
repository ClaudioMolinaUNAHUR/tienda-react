...
const Carrito = () => {
    ...
    return (
        ...
        <Table className='margin-top' bordered>
          ...
          <tfoot>
              <tr>
                  <td>Total</td>
                  <td colSpan={3}>
                      ${carrito.reduce((previousValue, currentValue) => previousValue + (currentValue.price * currentValue.cantidad),0).toFixed(2)
                      }
                  </td>
              </tr>
          </tfoot>
        ...
        <div className='d-flex justify-content-center mb-2'>                      
          <Button variant="success w-75 d-inline-block mx-auto">Iniciar Compra</Button>{' '} 
        </div>                           
      </>
    )
}
